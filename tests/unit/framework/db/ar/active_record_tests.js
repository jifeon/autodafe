...
//              return commands.find( model, 'find', '', {}, 0, '' )
//            },
////            topic: function (model) {
////              var command_emitter = new process.EventEmitter;
////
////              model.find('', {}).on('complete', function(res) {
////                command_emitter.emit('success', res);
////              });
////
////              return command_emitter;
...
//              var command_emitter = new process.EventEmitter;
//
//              model.find('id=:id', { id : 5 }).on('complete', function(res) {
//                command_emitter.emit('success', res);
//              });
//
//              return command_emitter;
...
//          'find without result'  : {
//            topic         : function(model) {
//              return commands.find(model, 'find', 'id=6', {}, 0, '')
//            },
...
//          'find_all command' : {
//            topic         : function(model) {
//              return commands.find(model, 'find_all', '', {}, 0, '')
//            },
...
//  t..get_db_connection().query("SELECT * FROM posts WHERE id = (SELECT id FROM users WHERE username={'user2','user3')",
//    function(res) {
