...
AppModule.prototype._init = function( params ) {
   ...
   * В теле методов контроллеров ( {@link Controller} ), моделей ( {@link Model} ), компонентов ( {@link Component} )
   * и т. д. можно смело использовать this.app для обращения к текущему приложению.
   *
   * @type {Application}
   */
