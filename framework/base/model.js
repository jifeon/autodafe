 ...
 *
 * @return {null|String|Number|Object} Возвращаемое значение зависит от количества ключевых атрибутов (<code>key</code>
 * в {@link Model.attributes}) Если у модели нет ключевых атрибутов - <code>null</code>, если у модели один ключевой
 * атрибут - это его значение, если у модели несколько ключевых атрибутов - это объект, ключи которого - названия
